export default {
  ...
  nav: {
    ...
    ai_agent_gemini_mcp: 'Gemini CLI 入門與 MCP 初次串接',
    ai_agent_notion_workflow: '使用 Notion 建立第一個 AI 工作流',
    ai_agent_security: '最小權限與安全邊界',
    ai_agent_primitives: 'Tools、Resources 與 Prompts 的分工',
    ai_agent_classroom_tools: '現成 MCP 的課堂版工具面設計',
    ai_agent_python_prep: 'Python 基礎：為自製 MCP Server 做準備',
    ai_agent_python_basics_1: '基礎一',
    ai_agent_python_basics_2: '基礎二',
    ai_agent_custom_server: '本機基礎：自製 MCP Server',
    ai_agent_custom_server_concepts: '觀念設計',
    ai_agent_custom_server_implementation: '實作步驟',
    ...
    urdf_example: '基本結構與範例解析',
    urdf_preview: '檔案的查看、修改與預覽',
    urdf_troubleshoot: '模型常見問題與排查方式',
    pybullet: 'PyBullet',
    gazebo: 'Gazebo',
    pb_guide: '學習導覽與地圖',
    pb_setup: '環境安裝與執行測試',
