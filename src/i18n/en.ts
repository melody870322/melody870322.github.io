export default {
  ...
  nav: {
    ...
    ai_agent_python_basics_1: 'Basics 1',
    ai_agent_python_basics_2: 'Basics 2',
    ai_agent_custom_server: 'Local Basic: Building Your Own MCP Server',
    ai_agent_custom_server_concepts: 'Concepts & Design',
    ai_agent_custom_server_implementation: 'Implementation Steps',
