export default {
  ...
  nav: {
    ...
    ai_agent_quota_and_cost: 'Quota, Cost & Request Count',
    ai_agent_session_context: 'Sessions & Memory Management',
    ...
    ai_agent_api_server_workflow: 'AI Workflow Design: From Using Tools to Structuring Tasks',
    ai_agent_real_tasks: 'Using AI Agents for Real Tasks',
    ai_agent_real_tasks_csv: 'Organizing CSV & Tabular Data',
    ai_agent_real_tasks_notion: 'Notion API in Practice: Building a Task Management MCP Tool',
    ai_agent_real_tasks_reading: 'Reading & Writing Workflow: From Understanding to Draft Revision',
    ai_agent_checklist: 'AI Workflow Design & Execution Checklist',
    ...
    pb_physics: 'Building the Physics World & Core API',
    gallery: 'Gallery',
    contact: 'Contact',
